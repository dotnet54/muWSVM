...
public class QuickHull2 extends Applet implements ActionListener
{
	...
	for ( int i = 1; i < pNum; i++ ) {
	    if ( ( xPoints[r] > xPoints[i] ) || 
	    		( xPoints[r] == xPoints[i] && yPoints[r] > yPoints[i] ))
		r = i;
	    if ( ( xPoints[l] < xPoints[i] ) || 
	    		( xPoints[l] == xPoints[i] && yPoints[l] < yPoints[i] ))
		l = i;
	}
